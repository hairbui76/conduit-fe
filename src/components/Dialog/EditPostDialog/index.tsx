...
export default function EditPostDialog({
  ...
  return (
    <DialogContent className="gap-6" onOpenAutoFocus={e => e.preventDefault()}>
      ...
      <Form {...updatePostForm}>
        <form onSubmit={updatePostForm.handleSubmit(onUpdatePost)} className="flex flex-col gap-4">
          <FormField
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="space-y-1">
                ...
                <FormDescription className="text-xs">Each tag separated by a comma</FormDescription>
              </FormItem>
            )}
          />
          <FormField
